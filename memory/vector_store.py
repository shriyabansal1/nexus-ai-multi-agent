...
class VectorStore:
    ...
    """
    def __init__(self,index_path: str = "memory/faiss.index",metadata_path: str = "memory/metadata.json",embedding_model: EmbeddingModel | None = None,):
    ...
    def search(self,query:str,k:int = 5,min_score:float =0.18,)->list[dict]:
